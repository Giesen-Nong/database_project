 ...
 * $_SESSION['class_id']对数据库进行查询，可以做好多好多事情*/
?>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="mdui-row">
        <div class="mdui-col-xs-12 mdui-col-md-2">
            <div class="rin-left">
                ...
                <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue rin-btn-left mdui-text-capitalize" href="#" style="background-color: #28A9E0;"><span class="iconfont iconabout"></span>账户管理</a>
            </div>
        </div>
            ...
            <div class="mdui-card rin-card" >
                <div class="info_container">
                    <div class="container" id="container1">
                        <h1 class="text-center">用户信息管理</h1>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($sqls)): ?>
                                <tr class="text-center">
                                    <td><?php echo $row['njs_UserNo_05']; ?></td>
                                    <td><?php echo $row['njs_UserPassword_05']; ?></td>
                                    <td><?php
                                        if($row['njs_UserLevel_05']==0){
                                            echo '管理员';
                                        }
                                        elseif ($row['njs_UserLevel_05']==1){
                                            echo '教师';
                                        }
                                        elseif ($row['njs_UserLevel_05']==2){
                                            echo '学生';
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="../api/del.php?id=<?php echo $row['njs_UserNo_05'];?>&db_table=nongjs_user_05" class="btn btn-danger">删除</a>
                                        <a href="../api/user_update.php?id=<?php echo $row['njs_UserNo_05'];?>&db_table=nongjs_user_05" class="btn btn-primary">修改</a>
                                    </td>
                                </tr>
                            <?php endwhile;?>
                            </tbody>
                        </table>
                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_user">添加账号信息</button>
                        <!-- 模态框（Modal） -->
