...
$classno = $user['njs_classNo_05'];
$sql_s = mysqli_query($mysqli, "select * from nongjs_classcourseopen_05 where njs_classNo_05='$classno' and njs_courseName_05 in (select njs_courseName_05 from nongjs_course_05
where njs_courseOpenSemester_05 like '$term%');");
