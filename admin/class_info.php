...
$sqls = mysqli_query($mysqli, 'select * from nongjs_class_05;');
session_start();
//使用一个会话变量检查登录状态
            ...
            <div class="mdui-card rin-card"  style="overflow-y: scroll" >
                <div class="info_container">
                    <div class="container" id="container1">
                        <h1 class="text-center">班级基本信息管理</h1>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($sqls)): ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="../api/del.php?id=<?php echo $row['njs_classNo_05'];?>&db_table=nongjs_class_05" class="btn btn-danger">删除</a>
                                        <a href="../api/class_update.php?id=<?php echo $row['njs_classNo_05'];?>&db_table=nongjs_class_05" class="btn btn-primary">修改</a>
                                    </td>
                                </tr>
                            <?php endwhile;?>
                            </tbody>
                        </table>
                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_user">添加班级信息</button>
                        <!-- 模态框（Modal） -->
