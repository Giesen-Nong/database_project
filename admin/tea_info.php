...
$sqls = mysqli_query($mysqli, 'select * from nongjs_teacher_05;');
session_start();
//使用一个会话变量检查登录状态
    ...
    <div class="mdui-row">
        <div class="mdui-col-xs-12 mdui-col-md-2">
            <div class="rin-left">
                ...
                <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue rin-btn-left mdui-text-capitalize" href='#' style="background-color: #28A9E0;"><span class="iconfont iconwiki"></span>教师信息</a>
                ...
                <a class="mdui-btn mdui-btn-raised rin-btn rin-btn-blue rin-btn-left mdui-text-capitalize" href="open_score.php"><span class="iconfont iconabout"></span>开课信息</a>
            ...
            <div class="mdui-card rin-card"  style="overflow-y: scroll" >
                <div class="info_container">
                    <div class="container" id="container1">
                        <h1 class="text-center">教师基本信息管理</h1>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($sqls)): ?>
                                <tr class="text-center">
                                    <td><?php echo $row['njs_teacherNo_05']; ?></td>
                                    <td><?php echo $row['njs_teacherName_05']; ?></td>
                                    <td><?php echo $row['njs_teacherSex_05']; ?></td>
                                    <td><?php echo $row['njs_teacherAge_05']; ?></td>
                                    <td><?php echo $row['njs_teacherTitle_05']; ?></td>
                                    <td><?php echo $row['njs_teacherTel_05']; ?></td>
                                    <td>
                                        <a href="../api/del.php?id=<?php echo $row['njs_teacherNo_05'];?>&db_table=nongjs_teacher_05" class="btn btn-danger">删除</a>
                                        <a href="../api/tea_update.php?id=<?php echo $row['njs_teacherNo_05'];?>&db_table=nongjs_teacher_05" class="btn btn-primary">修改</a>
                                    </td>
                                </tr>
                            <?php endwhile;?>
                            </tbody>
                        </table>
                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_user">添加教师信息</button>
                        <!-- 模态框（Modal） -->
